						...
						<div class="col-md-6">
							<form class="form-horizontal" role="form" method="GET" action="{{ URL::to('users') }}">
								<div class="input-group">
									<input id="search" name="search" 	type="text" class="form-control input-sm" placeholder="Buscar por RUN / Correo Electrónico">
							...
							<table class="table table-striped">
								...
								<tbody>
								  ...
								  <tr>
									...
									<td><a href="{{ URL::to('users/asignRole/' . $user->id ) }}">Modulo</a></td> 

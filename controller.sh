...
echo -e "\e[92m ######################################################################################################### \e[0m"
echo -e "\e[93m #                                                                                                       # \e[0m"
echo -e "\e[93m # Automatizacion Controller 1.8                                                                         # \e[0m"
echo -e "\e[93m #                                                                                                       # \e[0m"
echo -e "\e[92m ######################################################################################################### \e[0m"
echo -e "\e[93m # Junio 2020                                                                                            # \e[0m"
echo -e "\e[92m ######################################################################################################### \e[0m"
echo -e "\e[92m ######################################################################################################### \e[0m"
echo -e "\e[93m #                                                                                                       # \e[0m"
...
#Para Crear el controlador en /app/Http/Controllers/
...
#registra el archivo de migracion en /database/migrations
...
echo -e "\e[96m Ejecutando comando Artisan \e[0m"
...
echo "-------------------------------------------------------------------------------------------------------------------------" >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Creacion de modelo $nombre   " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Creacion archivo /app/$nombre"."php " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Creacion archivo /app/Http/Controllers/$Contr2 " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Creacion archivo /database/migration/$archivomigracion " >> wixan/log/log.txt

echo -e "\e[94m Creacion de modelo $nombre  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Creacion archivo /app/$nombre"."php  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Creacion archivo /app/Http/Controllers/$Contr2  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Creacion archivo /database/migration/$archivomigracion  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[92m  \e[0m"
echo -e "\e[92m  \e[0m"
...
echo "$(date +%y%m%d)_$(date +%H%M) -> Creacion del directorio resources/views/$nombre " >> wixan/log/log.txt

echo -e "\e[94m Creacion del directorio resources/views/$nombre  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
...
echo "$(date +%y%m%d)_$(date +%H%M) -> Creacion resources/views/$nombre/create.blade.php " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Creacion resources/views/$nombre/destroy.blade.php " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Creacion resources/views/$nombre/edit.blade.php " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Creacion resources/views/$nombre/index.blade.php " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Creacion resources/views/$nombre/show.blade.php " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Creacion resources/views/$nombre/store.blade.php " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Creacion resources/views/$nombre/update.blade.php " >> wixan/log/log.txt

echo -e "\e[94m Creacion resources/views/$nombre/create.blade.php > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Creacion resources/views/$nombre/destroy.blade.php > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Creacion resources/views/$nombre/edit.blade.php > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Creacion resources/views/$nombre/index.blade.php > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Creacion resources/views/$nombre/show.blade.php > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Creacion resources/views/$nombre/store.blade.php > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Creacion resources/views/$nombre/update.blade.php > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[92m  \e[0m"
echo -e "\e[92m  \e[0m"
################################################################################################################################################################
...
echo -e "\e[92m  \e[0m"
echo -e "\e[92m  \e[0m"
echo "$(date +%y%m%d)_$(date +%H%M) -> Creacion routes/web.php Route::resource('$nombre', '$conmayuscula$Contr'); " >> wixan/log/log.txt
echo -e "\e[94m Creacion routes/web.php Route::resource('$nombre', '$conmayuscula$Contr');  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[92m  \e[0m"
echo -e "\e[92m  \e[0m"
################################################################################################################################################################
...
echo "    		protected \$table = '$sub';                                 " >> app/$nombre.php
echo "    //																" >> app/$nombre.php
echo "    //																" >> app/$nombre.php
echo "    // Los campos que son asignables masivamente						" >> app/$nombre.php
echo "    protected \$fillable = [                 						    " >> app/$nombre.php
echo "    		'name','description','user_id'                              " >> app/$nombre.php
echo "    						];                                          " >> app/$nombre.php
echo "    //																" >> app/$nombre.php
echo "    // 																" >> app/$nombre.php
echo "    //																" >> app/$nombre.php
...
echo "$(date +%y%m%d)_$(date +%H%M) -> Informacion asignada en app/$nombre.php " >> wixan/log/log.txt
echo -e "\e[94m  -> Informacion asignada en app/$nombre.php  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[92m  \e[0m"
echo -e "\e[92m  \e[0m"
################################################################################################################################################################
...
echo "$(date +%y%m%d)_$(date +%H%M) -> app/Http/Controllers/$Contr2 " >> wixan/log/log.txt
echo -e "\e[94m  -> Informacion asignada en app/Http/Controllers/$Contr2  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[92m  \e[0m"
echo -e "\e[92m  \e[0m"
################################################################################################################################################################
...
echo "$(date +%y%m%d)_$(date +%H%M) -> php artisan cache:clear " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> php artisan auth:clear-resets " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> php artisan config:cache " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> php artisan config:clear " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> php artisan route:clear " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> php artisan view:clear" >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> composer clearcache" >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> composer dump-autoload" >> wixan/log/log.txt
echo "-------------------------------------------------------------------------------------------------------------------------" >> wixan/log/log.txt
...
echo "rm ../database/migrations/$asterisco$sub$tablefinal" >> wixan/$nombre$archivosh
echo "rm -rf ../resources/views/$nombre" >> wixan/$nombre$archivosh
echo "sed -i 's/\/\/ Rutas $nombre / /g' \"../routes/web.php\"" >> wixan/$nombre$archivosh
echo "sed -i '/$conmayuscula$Contr/d' ../routes/web.php" >> wixan/$nombre$archivosh
echo "rm $nombre$archivosh" >> wixan/$nombre$archivosh

echo "$(date +%y%m%d)_$(date +%H%M) -> Borrar  rm ../app/$nombre$archivo.php " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Borrar  rm ../app/Http/Controllers/$Contr2 " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Borrar rm ../database/migrations/$asterisco$sub$tablefinal " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Borrar rm -rf ../resources/views/$nombre " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Borrar rm -rf ../resources/views/$nombre " >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Borrar sed -i 's/\/\/ Rutas $nombre / /g' \"../routes/web.php\"" >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Borrar sed -i '/$conmayuscula$Contr/d' routes/web.php" >> wixan/log/log.txt
echo "$(date +%y%m%d)_$(date +%H%M) -> Borrar rm $nombre$archivosh" >> wixan/log/log.txt

echo -e "\e[94m Borrar  rm ../app/$nombre$archivo.php  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Borrar  rm ../app/Http/Controllers/$Contr2  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Borrar  rm ../database/migrations/$asterisco$sub$tablefinal  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Borrar  rm -rf ../resources/views/$nombre  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Borrar  sed -i 's/\/\/ Rutas $nombre / /g' \"../routes/web.php\"  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Borrar  sed -i '/$conmayuscula$Contr/d' routes/web.php  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
echo -e "\e[94m Borrar  rm $nombre$archivosh  > $(date +%y%m%d)_$(date +%H%M) \e[0m"
